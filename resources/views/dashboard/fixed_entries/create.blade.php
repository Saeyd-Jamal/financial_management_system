        ...
        <form action="{{ route('fixed_entries.store') }}" method="post" class="col-12">
            ...
            <div class="row">
                ...
                <div class="form-group p-3 col-3">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <button class="btn btn-outline-secondary" id="association_loan" type="button"
                                data-toggle="modal" data-target="#open_association_loan">
                                <i class="fe fe-maximize"></i>
                            </button>
                        </div>
                        <input value="0" type="text" class="form-control" placeholder="" aria-label=""
            ...
            @endforeach
            <div class="modal fade" id="open_association_loan" tabindex="-1" role="dialog"
                aria-labelledby="open_association_loanLabel" aria-hidden="true">
                <div class="modal-dialog  modal-dialog-centered" role="document" style="max-width: 75%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <form action="{{ route('fixed_entries.store') }}" method="post">
                                ...
                                <div class="row mt-3 align-items-center">
                                    ...
                                    <div class="form-group col-md-3 m-0">
                                        <x-form.input name="association_loan_basic" type="number"
                                            class="d-inline association_loan_fields" placeholder="4000...." />
                                    </div>
                                    <span>ويصرف على كل شهر</span>
                                    <div class="form-group col-md-3 m-0">
                                        <x-form.input name="association_loan_months" type="number"
                                            class="d-inline association_loan_fields" placeholder="200..." />
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                            ...
                                            <tr>
                                                <td>
                                                    <input value="0" type="number" id="{{ $name }}_month-1"
                                                        name="{{ $name }}_month-1"
                                                        class="form-control association_loan_fields_month"
                                ...
                                <div class="row mt-3 align-items-center">
                                    ...
                                    <div class="form-group col-md-3 m-0">
                                        <x-form.input name="total_association_loan" type="number" class="d-inline"
                                            placeholder="4000...." />
                                    </div>
                                </div>
                                <div class="modal-footer">
