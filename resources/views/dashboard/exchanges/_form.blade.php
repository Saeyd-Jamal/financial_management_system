    ...
    <div class="col-md-8">
        <div class="row">
            ...
            <div class="form-group p-3 col-4">
                <x-form.input type="date" label="تاريخ الصرف" :value="$exchange->discount_date" name="discount_date" required/>
            </div>
            <div class="form-group p-3 col-4">
                ...
                <select class="custom-select" id="exchange_type" name="exchange_type" required>
                    ...
                    <option value="reward" @selected($exchange->exchange_type == 'reward')>مكافأة</option>
                </select>
            </div>
        </div>
