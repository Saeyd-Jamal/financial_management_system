...
class LoanController extends Controller
{
     ...
     */
    public function show(Request $request, Loan $fixedEntries)
    {
    ...
    {
        $this->authorize('edit', Loan::class);
        if($request->ajax()) {
    ...
    public function destroy(FixedEntryRequest $request ,$id)
    {
        ...
        // $fixedEntries = Loan::findOrFail($id);
        // $fixedEntries->delete();
    ...
    public function print(Request $request,$id){
        ...
        $pdf = PDF::loadView('dashboard.pdf.employee.employee_loans',
        ['employee' => $employee,
            'year' => $year,
            'name_loan' => $name_loan,
            'field' => $request['field'],
